...
const Header = () => {
    ...
    const NavLink = ({title}) => (
        <LinkScroll  onClick={() => setIsOpen(false)} to={title} offset={-100} spy smooth activeClass='nav-action'
        ...
        <header className= {clsx('fixed top-0 left-0 z-50 w-full py-10 transition-all duration-500 max-lg:py-4', hasScrolled && 'py-2 bg-black-100 backdrop-blur-[8px]')}>
            <div className='container flex h-14 items-center max-lg:px-5'>
                <a className='lg:hidden flex-1 cursor-pointer z-2'>
                    <img src="/SAAS_LANDING_PAGE/public/images/xora.svg" width={115} height={55} alt="logo" />
                </a>
                <div className={clsx('w-full max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:w-full max-lg:bg-s2 max-lg:opacity-0 ', isOpen ? 'max-lg:opacity-100': 'max-lg:pointer-events-none')}  >
                    ...
                    max-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden sidebar-before max-md:px-4'>
                            ...
                            <ul className='flex max-lg:block max-lg:px-12'>
                                ...
                                <li className='nav-logo'>
                                    <LinkScroll to='hero' offset={-270} spy smooth 
                                        ...
                                        <img src="/SAAS_LANDING_PAGE/public/images/xora.svg" width={160} height={55} alt="logo" />
                                    </LinkScroll>
                                </li>
                                <li className='nav-li'>
                                    <NavLink title='faq' />
                        ...
                        <div className='lg:hidden block absolute top-1/2 left-0 w-[960px] h-[380px] translate-x-[-290px] -translate-y-1/2 rotate-90'>
                            <img src="/SAAS_LANDING_PAGE/public/images/bg-outlines.svg"  
                                 width={960} 
                                 height={380} 
                                 alt="outline" 
                                 className='relative z-2'
                            />
                            <img src="/SAAS_LANDING_PAGE/public/images/bg-outlines-fill.png"  
                                 width={960} 
                                 height={380} 
                                 alt="outline" 
