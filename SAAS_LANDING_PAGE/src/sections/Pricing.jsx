            ...
            <div className="container">
                <div className="max-w-960 pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
                    ...
                    <div className="pricing-bg">
                        <img src="/SaaS_App_Landing_Page/images/bg-outlines.svg" width={960} height={380} alt="outline" className="relative z-2" />
                        <img src="/SaaS_App_Landing_Page/images/bg-outlines-fill.png" width={960} height={380} alt="outline" className="absolute inset-0 opacity-5 mix-blend-soft-light" />
                    </div>
                </div>
                {/* pricing section */}
                            ...
                            <ul className="mx-auto space-y-4 xl:px-7">
                                {plan.features.map((feature => (
                                    <li key = {feature} className="relative flex items-center gap-5">
                                        <img src={"/SaaS_App_Landing_Page/images/check.png"} alt="check" className="size-10 object-contain" />
